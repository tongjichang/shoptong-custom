...
app.controller('updateshoppController',function($scope,$http,$window,$routeParams,$log,$ocLazyLoad){
        ...
        $http({
            ...
            .success(function (data,status) {
                if(data.CODE=='1000'){
                    ...
                    $scope.print_way = data.DATA.print_way;
                }else{
                    show_alert_box('提示',data.MESSAGE);
                }
