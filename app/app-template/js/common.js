...
$(document).ready(function(){
	...
	PopUplayer("#submit_cart","#DetailContent","#DetailContent .button","DetailLayer")  // 顾客确认订单
	//PopUplayer("#Edit-Address","#Edit-Address-Content","#Edit-Address-Content .close","Edit-Address-Layer")  // 编辑地址
	//PopUplayer("#submit_cart,#order-Edit-address,#Edit-Address-Content .head-r","#Add-Address-Content","#Add-Address-Content .close","Add-Address-Layer")  // 添加地址
